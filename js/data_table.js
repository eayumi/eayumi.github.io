...
function data_table_Besucher() {
    d3.json('../data/data_table_Besucher.json').then(function(data_table) {
        ...
        document.getElementById('title_B').innerHTML = '(Absolute Values)';

        var table = $('#example_B').DataTable({
            "paging": false,
            "info": false,
            dom: 'Bfrtip',
            "searching": false,
            ...
            buttons: {
                ...
                buttons: [{ extend: 'excel', className: 'excelButton' },
                    //
                    {
                        ...
                        action: function() {
                            currentClassesShow = 'avg'
                            document.getElementById('title_B').innerHTML = '(Average Values)';
                        ...
                        action: function() {
                            ...
                            document.getElementById('title_B').innerHTML = '(Percentage Values)';
                            table.columns(".avg").visible(false);
                            table.columns(".perc").visible(true);
                            table.columns(".normal").visible(false);
    ...
    d3.json('../data/data_table_2020_Besucher.json').then(function(data_table) {
        ...
        document.getElementById('title2020_B').innerHTML = '(Absolute Values)';

        var table = $('#igong_B').DataTable({
            "paging": false,
            "info": false,
            dom: 'Bfrtip',
            "searching": false,
            ...
            buttons: {
                ...
                buttons: [{ extend: 'excel', className: 'excelButton' },
                    //
                    {
                        ...
                        action: function() {
                            currentClassesShow = 'avg'
                            document.getElementById('title2020_B').innerHTML = '(Average Values)';
                        ...
                        action: function() {
                            ...
                            document.getElementById('title2020_B').innerHTML = '(Percentage Values)';
                            table.columns(".avg").visible(false);
                            table.columns(".perc").visible(true);
                            table.columns(".normal").visible(false);
